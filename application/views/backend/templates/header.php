...
<head>
	...
	<!-- endinject -->
	<link rel="shortcut icon" href="<?=base_url()?>assets/frontend/img/cv-chs/logo-chs.png" />
</head>
<body>
<div class="container-scroller">
	...
	<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row d-print-none" >
		<div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
			<a class="navbar-brand brand-logo" href="<?=base_url('admin')?>"><img src="<?=base_url()?>assets/frontend/img/cv-chs/logo-chs.png" style="width: 12%" alt="logo"/></a>
			<a class="navbar-brand brand-logo-mini" href="<?=base_url('admin')?>"><img src="<?=base_url()?>assets/frontend/img/cv-chs/logo-chs.png" alt="logo"/></a>
		</div>
