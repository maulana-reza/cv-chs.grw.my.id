...
class PesanController extends CI_Controller
{
	...
	public function pesanSpanduk()
	{
		...
		$data = array(
			'title' => 'Pesan Spanduk | Percetakan CV.CHS'
		);
	...
	public function pesanStiker(){
		...
		$data = array(
			'title' => 'Pesan Stiker | Percetakan CV.CHS'
		);
		$this->load->view('frontend/templates/header',$data);
	...
	public function pesanKartu(){
		...
		$data = array(
			'title' => 'Pesan Kartu Nama | Percetakan CV.CHS'
		);
		$this->load->view('frontend/templates/header',$data);
	...
	public function pesanBrosur(){
		...
		$data = array(
			'title' => 'Pesan Brosur | Percetakan CV.CHS'
		);
		$this->load->view('frontend/templates/header',$data);
	...
	public function hapusKartu($id){
		...
		$this->PesanModel->delete('kartu_id',$id,'cv-chs_kartu');
	...
	public function hapusSpanduk($id){
		...
		$this->PesanModel->delete('spanduk_id',$id,'cv-chs_spanduk');
		$this->BayarModel->update_keranjang($keranjang_id,$data);
		$this->session->set_flashdata('alert', 'pesan_hapus');
		redirect('keranjang');
	}
	...
	public function hapusStiker($id){
		...
		$this->PesanModel->delete('stiker_id',$id,'cv-chs_stiker');
		$this->BayarModel->update_keranjang($keranjang_id,$data);
		$this->session->set_flashdata('alert', 'pesan_hapus');
		redirect('keranjang');
	}
	...
	public function hapusBrosur($id){
		...
		$this->PesanModel->delete('brosur_id',$id,'cv-chs_brosur');
		$this->BayarModel->update_keranjang($keranjang_id,$data);
		$this->session->set_flashdata('alert', 'pesan_hapus');
		redirect('keranjang');
	}
